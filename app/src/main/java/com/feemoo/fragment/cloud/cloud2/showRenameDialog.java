...
public class showRenameDialog {
    ...
    public void CenterDialog(Context context, FilesModel data, String name, int position) {
     ...
     * @param position
     */
    private void rename(Context context, FilesModel data, String name, int position) {
        loaddingDialog.show();
        RetrofitUtil.getInstance().filerename(SharedPreferencesUtils.getString(context, "token"), name, Integer.parseInt(data.getId()), new Subscriber<BaseResponse<String>>() {
            @Override
