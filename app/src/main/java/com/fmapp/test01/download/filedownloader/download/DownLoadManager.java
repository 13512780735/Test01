...
package com.fmapp.test01.download.filedownloader.download;

import android.content.Context;
import android.content.SharedPreferences;

import com.fmapp.test01.download.filedownloader.download.DownLoader.DownLoadSuccess;
import com.fmapp.test01.download.filedownloader.download.dbcontrol.DataKeeper;
import com.fmapp.test01.download.filedownloader.download.dbcontrol.FileHelper;
import com.fmapp.test01.download.filedownloader.download.dbcontrol.bean.SQLDownLoadInfo;
